			...
			<div class="page-wrapper">
				<div class="content">
								...
								<div class="col-lg-3 col-sm-6 col-12">
									<div class="form-group">
										...
										<div class="col-lg-12 mt-3" >
											<a href="javascript:void(0);" onclick="buscar_ruc();" class="btn btn-submit me-2">Enviar</a>
					...
					<div class=" col-lg-12 card p-3 m-3" style="background-color:#0F4582; border-radius: 15px;">
						<div class="row align-items-center">
							<div class="col-lg-4 ">
								<!-- Tarjeta 1 -->
								<div class="card" style="border: 0;">
									<div class="card-body" style="background-color:#0F4582; color:white ; ">
										<h5 class="card-title" style="color:white">RUC</h5>
							...
							<div class="col-lg-4">
								...
								<div class="card" style="border: 0;">
									<div class="card-body" style="background-color:#0F4582; color:white">
										<p class="" id="nombre_estudiante">Razon Social</p>
										<p class="" id="ape_pat">RUC:</p>
										<p class="" id="ape_mat">Estado</p>
										<p class="" id="">Condicion</p>
										<p class="" id="direccion">Direccion: </p>
									</div>
								</div>
							</div>
        ...
        <script>
			...
			// Llamar a la función para mostrar la hora actual al cargar la página
				...
				function buscar_ruc(){
					var ruc = $('#input_dni').val();
					$.ajax({
						type: "POST",
						url: '<?php echo base_url();?>Controller_producto/buscar_ruc',
						data: {
							'ruc':ruc							
						}, 
						dataType: 'json',
						...
						success: function(data){ 
							...
							//alert(data);
							if (data){
								$('#nombre_estudiante').text(data.razonSocial);
								$('#identificacion').text('DNI: ' + data.ruc);
								$('#ape_pat').text(data.estado);
								$('#ape_mat').text(data.condicion);
