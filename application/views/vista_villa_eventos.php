				...
				<div class="content">
					<div class="page-header">
						<div class="page-title">
							...
							<h6>Administración de eventos registrados</h6>
						</div>
						<div class="page-btn">
							<a href="<?php echo base_url();?>eventos/eventos_add" class="btn btn-added"><img src="<?php echo base_url();?>public/assets/img/icons/plus.svg" alt="img" class="me-1">Agregar nuevo Evento</a>
						</div>
					</div>
									...
									<div class="row">
										<div class="col-lg-12 col-sm-12">
											<div class="row">
												<div class="col-lg-3 col-sm-3 col-12">
													<div class="form-group">
														<select class="select" id="select_estado" onchange="active_filter('select_estado');">
                                                            <?php
																echo '<option value="">Estado de evento</option>';
												...
												<div class="col-lg-3 col-sm-3 col-12">
													<div class="form-group">
														<select class="select" id="select_tipo_evento" onchange="active_filter('select_tipo_evento');">
															<?php
																echo '<option value="">Tipo de evento</option>';
																foreach ($lst_tipos_eventos as $key) {
																	echo '<option value="'.$key->id.'">'.$key->descripcion.'</option>';
																}
                                                            ?>														
														</select>
        ...
        <script>
                ...
                $(document).ready(function() {				
                    forDataTables('#tb_table','Controller_villa_eventos/listar'); 
                });
				...
				function active_filter(tipo){
					...
					$.ajax({
						type: "POST",
						url: '<?php echo base_url();?>Controller_villa_eventos/active_filter',
						data: {
							'dato':dato,
							'tipo':tipo
						}, 
