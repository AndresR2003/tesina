        <?php 
            ...
            //paneles disponibles
            $panel_agenda       ="display:none";
            $panel_cotizacion   ="display:none";
            $panel_proforma     ="display:none";
            ...
            $id_zona        ="";
            $direccion      ="";
            foreach ($lst_data_cliente as $key) {
            ...
            $id_proforma        = "";
            $id_estado_evento        = "";
            foreach ($lst_data_evento as $key) {
                $id_tipo_evento         =$key->id_tipo_evento;
                if($id_tipo_evento){
                    $panel_cotizacion   ="display:block;";
                    $panel_proforma     ="display:block;";
                    $panel_agenda       ="display:none;";
                }else{
                    $panel_agenda       ="display:block;";
                    $panel_cotizacion   ="display:none;";
                    $panel_proforma     ="display:none;";
                }
                $id_cliente             =$key->id_cliente;
                $fecha_registro         =$key->fecha_registro;
                $usuario_registro       =$key->usuario_registro;
                $id_estado_evento       =$key->id_estado_evento;
				...
				<div class="content">
					<div class="page-header">
						<div class="page-title">
							<h4>Editar Evento</h4>
							<h6>Editar evento registrado </h6>
						</div>
					</div>
							...
							<div class="row">
                                ...
                                <div class="col-lg-3 col-sm-6 col-12">
									<div class="form-group">
										...
										<input type="text" id="input_nro_documento" placeholder="Ingrese número de documento" onchange="get_data_nro_documento()" disabled value="<?php echo $nro_documento;?>">
								...
								<div class="col-lg-3 col-sm-6 col-12">
									<div class="form-group">
										<label>Nombres</label>
										<input type="text" id="input_nombre" placeholder="Ingrese nombres completos" value="<?php echo $nombres;?>">
								...
								<div class="col-lg-3 col-sm-6 col-12">
									<div class="form-group">
										...
										<input type="text" id="input_apellido" placeholder="Ingrese apellidos completos" value="<?php echo $apellidos;?>">
								...
								<div class="col-lg-3 col-sm-6 col-12">
									<div class="form-group">
										<label>Celular</label>
										<input type="text" id="input_celular_1" placeholder="Ingrese número de celular" maxlength="12" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" value="<?php echo $celular_1;?>">
								...
								<div class="col-lg-3 col-sm-6 col-12">
									<div class="form-group">
										<label>Celular</label>
										<input type="text" id="input_celular_2" placeholder="Ingrese número de celular" maxlength="12" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" value="<?php echo $celular_2;?>">
					...
					<div class="card">
						<div class="card-body">
							<div class="row">
								...
								<div class="col-lg-3 col-sm-6 col-12" style="<?php echo $panel_proforma;?>" id="panel_proforma">
									<div class="form-group">
                    ...
                    <!--AGENDA DE CITA-->
					<div class="card" id="panel_agenda" style="<?php echo $panel_agenda;?>">
						<div class="card-body">
							<div class="row">
								<div class="col-lg-12 col-sm-12 col-12">
                                    <h4>Agendar Cita</h4>
                    ...
                    <!--AGENDA DE CITA-->
					<div class="card" id="panel_cotizacion" style="<?php echo $panel_cotizacion;?>">
						<div class="card-body">
							<div class="row">
								<div class="col-lg-12 col-sm-12 col-12">
                                    <h4>Cotizador</h4>
                                ...
                                <div class="col-lg-1 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <button class="btn btn-secondary " onclick="add();"> Agregar </button>
                                    </div>
                                </div>
								<div class="col-lg-12 col-sm-12 col-12">
										...
										<table class="table table-bordered mb-0">
                                            ...
                                            <tfooter>
                                                <tr>
                                                    ...
                                                    <td> <strong><label id="t_total">00.00</label></strong></td>
                                                </tr>                                                
                                            </tfooter>
										</table>
									</div>
                                ...
                                <!--<div class="col-lg-1 col-sm-6 col-12 mt-1">
                                    <div class="form-group">
                                        <button class="btn  btn-sm btn-cancel" onclick="save_cotizacion();"> Grabar</button>
                                    </div>
                                </div>-->															 								
							</div>
						</div>
					...
					<div class="card">
						<div class="card-body">
							<div class="row">
								<div class="col-lg-12 col-sm-12 col-12">
                                    <h4>Estado actual del evento</h4>
                                </div>
								<div class="col-lg-3 col-sm-6 col-12">
									<div class="form-group">
										<label>Situación del evento </label>
										<select class="form-control" id="select_estado_evento">
											<option value="">Seleccion</option>
											<?php
												foreach ($lst_estados_evento as $key) {
                                                    if($id_estado_evento==$key->id){
                                                        echo '<option selected value="'.$key->id.'">'.$key->descripcion.'</option>';
                                                    }else{
                                                        echo '<option  value="'.$key->id.'">'.$key->descripcion.'</option>';
                                                    }
										...
										<div class="valid-feedback" id="select_estado_evento_success">
											Se ve bien!
										</div>
										<div class="invalid-feedback" id="select_estado_evento_error">
								...
								<div class="col-lg-3 col-sm-6 col-12">
									<div class="form-group">
                                        ...
                                        <button class="btn btn-secondary" onclick="save_estado_evento();"> Grabar</button>
									</div>
								</div>                                   
							</div>
						</div>
    ...
    function save_estado_evento(){
        var id_estado_evento = get_value('select_estado_evento');
        var id_evento = get_value('id_evento');
		$.ajax({
			type: "POST",
			url: '<?php echo base_url();?>Controller_villa_eventos/save_estado_evento',
			data: {
    ...
    function add(){
        ...
        var id_cliente = get_value('id_cliente');
        var id_evento = get_value('id_evento');
        if(id_producto!='' && cantidad!='' && id_evento!='0' && id_cliente!=''){
            $.ajax({
                type: "POST",
                url: '<?php echo base_url();?>Controller_villa_cotizacion/add_cotizacion_producto',
                data: {
    ...
    function get_cotizacion(){
        var id_evento = <?php echo "'".$id_evento."'";?>;
        if(id_evento!=''){
            $.ajax({
                type: "POST",
                url: '<?php echo base_url();?>Controller_villa_cotizacion/get_cotizacion',
                data: {
                    'id_evento':id_evento
                }, 
                beforeSend:function(){
    ...
    */
	...
	function delete_id(id){
        $.ajax({
			type: "POST",
			url: '<?php echo base_url();?>Controller_villa_cotizacion/delete_x_id_cotizacion',
			data: {
				'id':id
			}, 
			beforeSend:function(){
