<div class="page-wrapper">
            <div class="content">
                <div class="page-header">
                    <div class="page-title">
                        <h4>Agregar Sub-categoría de productos</h4>
                        <h6>Crear nueva sub-categoría de producto</h6>
                    </div>
                </div>
                <!-- /add -->
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="invalid-feedback" id="input_nombre_error">
                                        Por favor, ingrese el nombre de la sub-categoría.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <a href="<?php echo base_url();?>subcategory_list" class="btn btn-cancel">Cancelar</a>
                            </div>
                        </div>
                    </div>
                </div>
	...
	function insert(){
		...
		$.ajax({
			type: "POST",
			url: '<?php echo base_url();?>Controller_subcategoria/insert',
			data: {
			...
			success: function(data){ 
				if(data=='1'){
                    ...
                    restablecer_inputs();
					Swal.fire({ 
						title: "Sub-categoría agregada!", 
						text: "Gracias por registrar una nueva categoría!", 
