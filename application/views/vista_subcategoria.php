				...
				<div class="content">
					<div class="page-header">
						<div class="page-title">
							<h4>Lista de Sub-Categorías</h4>
							<h6>Administra las subcategorìas de tu catàlogo.</h6>
						</div>
						<div class="page-btn">
							<a href="<?php echo base_url();?>subcategory_add" class="btn btn-added"><img src="<?php echo base_url();?>public/assets/img/icons/plus.svg" alt="img" class="me-1">Agregar nueva subcategoría</a>
						</div>
					</div>
						...
						<div class="card-body">
							<div class="table-top">
								...
								<div class="wordset">
									<ul>
										<li>
											<a target="_blank" href="<?php echo base_url(); ?>Controller_exportar/exportar_subcategory_pdf" data-bs-toggle="tooltip" data-bs-placement="top" title="pdf"><img src="<?php echo base_url();?>public/assets/img/icons/pdf.svg" alt="img"></a>
										</li>
										<li>
											<a target="_blank" href="<?php echo base_url(); ?>Controller_exportar/exportar_subcategory" data-bs-toggle="tooltip" data-bs-placement="top" title="excel"><img src="<?php echo base_url();?>public/assets/img/icons/excel.svg" alt="img"></a>
										</li>										
										<!--<li>
        ...
        <script>
			...
			$(document).ready(function() {
				forDataTables('#tb_table','Controller_subcategoria/listar'); 
			});
