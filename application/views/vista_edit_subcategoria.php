				...
				<div class="content">
					<div class="page-header">
						<div class="page-title">
							<h4>Editar Sub-Categoría</h4>
							<h6>Actualizar Sub-categoría</h6>
						</div>
					</div>
...
?>
        ...
        <script>
			...
			function update(id){
				...
				$.ajax({
					type: "POST",
					url: '<?php echo base_url();?>Controller_subcategoria/update',
					data: {
						'id':id,
					...
					success: function(data){ 
						if(data=='1'){
							...
							Swal.fire({ 
								...
								text: "Se actualizó correctamente los detalles de la Sub-categoría.", 
