...
class Mdl_compartido extends CI_Model
{
    ...
    public function permisos_menu()
    {
        ...
        if($permiso == 100){
            return array('control_monitoreo','control_servicio','calificacion','actividad','monitoreo','dashboard','dashboard_usuario','agenda','control_marcador','dashboard_marcador','dashboard_productividad','dashboard_control_audio_marcador','informes_amicar','usuario_integra','usuarioxcampania_integra','monitoreo_integra','informe_integra','campania_audios','usuario_audios','monitoreo_audios','informe_audios','perfil','system_link','view_recursos'); 
        }elseif($permiso == 80){
    ...
    //Get_data_select
    function get_data_select($select,$table,$campo,$dato){
