    ...
    function layoutSetting() {
        ...
        $("input[name='layout']").on('change', function () {
            ...
            if($(this).val()=="vertical"){
                $.ajax({
                    type: "POST",
                    url: 'http://172.21.8.50/monitoreo/settings/activar_session_vertical',
                    data: {}, 
                    beforeSend:function(){
                    },   
                ...
                $.ajax({
                    type: "POST",
                    url: 'http://172.21.8.50/monitoreo/settings/activar_session_horizontal',
                    data: {}, 
                    beforeSend:function(){
                    },   
                    success: function(data){ 
        ...
        $("input[name='layout-mode']").on('change', function () {
            ...
            $.ajax({
                type: "POST",
                url: 'http://172.21.8.50/monitoreo/settings/set_layout_mode',
                data: {'dato':$(this).val()}, 
                beforeSend:function(){
                },   
                success: function(data){ 
        ...
        $("input[name='layout-width']").on('change', function () {
            ...
            $.ajax({
                type: "POST",
                url: 'http://172.21.8.50/monitoreo/settings/set_layout_width',
                data: {'dato':$(this).val()}, 
                beforeSend:function(){
                },   
                success: function(data){ 
        ...
        $("input[name='layout-position']").on('change', function () {
            ...
            $.ajax({
                type: "POST",
                url: 'http://172.21.8.50/monitoreo/settings/set_layout_position',
                data: {'dato':dato}, 
                beforeSend:function(){
                },   
                success: function(data){ 
        ...
        $("input[name='sidebar-color']").on('change', function () {
            ...
            $.ajax({
                type: "POST",
                url: 'http://172.21.8.50/monitoreo/settings/set_sidebar_color',
                data: {'dato':dato}, 
                beforeSend:function(){
                },   
                success: function(data){ 
        ...
        $("input[name='topbar-color']").on('change', function () {
            ...
            $.ajax({
                type: "POST",
                url: 'http://172.21.8.50/monitoreo/settings/set_topbar_color',
                data: {'dato':$(this).val()}, 
                beforeSend:function(){
                },   
                success: function(data){ 
        ...
        $("input[name='sidebar-size']").on('change', function () {
            ...
            $.ajax({
                type: "POST",
                url: 'http://172.21.8.50/monitoreo/settings/sidebar_size',
                data: {'dato':dato}, 
                beforeSend:function(){
                },   
                success: function(data){ 
